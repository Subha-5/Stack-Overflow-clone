  ...
  function handleChange(event) {
    ...
    setNote((prevNote) => {
      return {
        ...
        [name]: value // Computer property names
      };
    });
  }
  */
    ...
    <div>
      <section className="auth-section">
        ...
        <div className="auth-container-2">
          {!isSignup &&
            <img src={icon} alt='stack overflow' className='login-logo' height={'40px'} />}
          <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="password">
              ...
              {isSignup &&
                <p style={{ color: "#666767", fontSize: "13px" }}>Password must contain at least eight characters,<br /> including at least 1 letter and 1 number<br /></p>}
            </label>
          ...
          <p>
            ...
            <button type="submit" className="handle-switch-btn" onClick={handleSwitch}>

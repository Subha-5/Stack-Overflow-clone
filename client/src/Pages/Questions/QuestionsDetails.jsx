                                    ...
                                    <div key={question._id}>
                                                    ...
                                                    <div className="question-actions-user">
                                                        ...
                                                        <div>
                                                            ...
                                                            <Link to={`/Users/${question.userId}`} className='user-link' style={{ color: "#0086d8" }}>
                                                                <Avatar
                                                                    backgroundColor={"orange"} color={'#fff'} px='8px' py='5px' borderRadius={'0%'} fontSize='18px' cursor={'pointer'}>{question.userPosted.charAt(0).toUpperCase()}
                                                                </Avatar>
                                                                <div>
                                                                    {question.userPosted}
                                                                </div>
                                        ...
                                        <section className="post-ans-container">
                                            ...
                                            <form onSubmit={e => handlePostAnswer(e, question.answer.length)}>
                                                <textarea name="" id="" cols="30" rows="10" onChange={e => setAnswerBody(e.target.value)}></textarea>

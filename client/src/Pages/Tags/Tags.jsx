...
const Tags = () => {
    const tagsList = [{
        ...
        id: 2,
        tagName: "python",
        tagDesc: "Python is a multi-paradigm, dynamically typed, multipurpose programming language. It is designed to be quick to learn, understand, and use, enforces a clean and uniform syntax."
    }, {
        id: 3,
        tagName: "c#",
        ...
        id: 7,
        tagName: "android",
        tagDesc: "Android is Google's mobile operating system, used for programming or developing digital services (Smartphones, Tablets, Automobiles, TVs, Wear, Glass, IoT)."
    }, {
        id: 8,
        tagName: "css",
        ...
        id: 10,
        tagName: "node.js",
        tagDesc: "Node.js is an event-based, non-blocking, asynchronous I/O runtime that uses Google's V8 JavaScript engine and lubv library."
    }]
